...
```bash
git clone https://github.com/<your-github-username>/Stackoverflow-Analysis
```
...
```bash
git remote add upstream https://github.com/original-owner-username/Stackoverflow-Analysis
```
